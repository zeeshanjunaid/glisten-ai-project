      ...
      <div className="mt-20 grid gap-16">
        {caseStudies.map(
          (caseStudy, index) =>
            caseStudies && (
              <div
                className="md:grdi-cols-2 relative grid gap-4 opacity-85 transition-opacity duration-300 hover:cursor-pointer hover:opacity-100 md:gap-8 lg:grid-cols-3"
                key={caseStudy?.id}
              >
